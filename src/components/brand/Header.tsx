    ...
    <header className="sticky top-0 z-40 bg-espresso text-cream border-b border-white/10">
      <div className="container-hiba flex items-center justify-between py-4">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link
            to="/cart"
            className="relative inline-flex items-center justify-center h-10 w-10 rounded-full border border-white/20 hover:bg-white/5 transition"
            aria-label="Cart"
          >
            <ShoppingBag className="h-4 w-4" />
            {count > 0 && (
              <span className="absolute -top-1.5 -right-1.5 flex h-5 w-5 items-center justify-center rounded-full bg-terracotta text-[10px] font-medium text-terracotta-foreground">
                {count}
              </span>
            )}
          </Link>
        ...
        <div className="flex items-center gap-2 md:hidden">
          <Link
            to="/cart"
            className="relative inline-flex items-center justify-center h-10 w-10 rounded-md border border-white/20"
            aria-label="Cart"
          >
            <ShoppingBag className="h-4 w-4" />
            {count > 0 && (
          ...
          <button
            className="inline-flex items-center justify-center h-10 w-10 rounded-md border border-white/20"
            onClick={() => setOpen((v) => !v)}
            aria-label="Menu"
          >
